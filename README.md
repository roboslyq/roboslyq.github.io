...
**[中文版 Chinese README 请点击这里 🇨🇳](https://github.com/roboslyq/roboslyq.github.io/blob/master/README-zh-cn.md)**
...
**My Blog Url: [http://roboslyq.github.io/](http://roboslyq.github.io/)**. If you like this theme, you can give me a star to encourage me. Welcome everyone to use it.
...
**Welcome to use this blog theme, but please keep the theme author info at footer.** Theme designed by [HyG](https://github.com/roboslyq).
...
url: "http://roboslyq.github.io" # the base hostname & protocol for your site
```
...
```yml
# other links
twitter_username: roboslyq126
facebook_username: roboslyq.water
github_username:  roboslyq
email: roboslyq126@126.com
weibo_username: 3115521wh
zhihu_username: roboslyq
linkedIn_username: roboslyq
dribbble_username:
...
|:----------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| [![PayPal](https://www.paypalobjects.com/webstatic/paypalme/images/pp_logo_small.png)<br>Donate via PayPal ](https://www.paypal.me/roboslyq) | ![wechat](http://ww2.sinaimg.cn/large/7011d6cfjw1f3bkdw3bslj206z06q3z6.jpg) | ![alipay](http://ww2.sinaimg.cn/large/7011d6cfjw1f3bk8ikzoij20740743z5.jpg) |
...
- `[^]` fix smoothScroll bug in Tencent webview like wechat and qq.  [#22](https://github.com/roboslyq/roboslyq.github.io/issues/22), [#48](https://github.com/roboslyq/roboslyq.github.io/issues/48)
...
* `[^]` Fix bug in tags cloud when division by zero. [#26](https://github.com/roboslyq/roboslyq.github.io/issues/26), [#28](https://github.com/roboslyq/roboslyq.github.io/issues/28), [#30](https://github.com/roboslyq/roboslyq.github.io/issues/30)
...
About my old blog theme, I won't maintain any more. And I put the code at  [roboslyq/old-blog](https://github.com/roboslyq/old-blog).

## License

[MIT License](https://github.com/roboslyq/roboslyq.github.io/blob/master/LICENSE.md)
